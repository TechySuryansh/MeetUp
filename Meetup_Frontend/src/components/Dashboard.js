          ...
          <div className="space-y-2">
            {sortedUsers.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 text-xs mt-1">Invite someone to join!</p>
              </div>
            ) : (
        ...
        <div className="flex-1 p-8">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-500 mb-2">{sortedUsers.length}</div>
                <div className="text-gray-400">Total Users</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-500 mb-2">{onlineCount}</div>
